...
--
-- Host: localhost
-- Generation Time: Oct 05, 2023 at 06:36 AM
...
-- Database: `pupilheart`
--
CREATE DATABASE IF NOT EXISTS `pupilheart` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `pupilheart`;
...
('76k8majcsgwecu7a3p5r1iuvl8iiz0f6', 'eyJ1c2VyaWQiOjF9:1qo0jj:a-7Jjp5fRyxO9Mtc8yh-tMuBH6LqO9WlGyKQWLhCWUc', '2023-10-18 12:12:19.425018'),
...
('eo7mosj5aec0lqlvuz0iudminzw4t4x6', 'eyJ1c2VyaWQiOjN9:1pI2sC:cdfVAoEgzwtZv4JFJ8H7UbmMV3UmHw2P7wPH5DdvWD8', '2023-02-01 07:28:40.516548'),
...
('oppq3u2pucca3dmkt13ab453l6p9i24h', 'eyJ1c2VyaWQiOjN9:1qo2Fz:1GU4dMc99q_9GthvmKvgu9HUYrT-bAXESmsOpF9jN60', '2023-10-18 13:49:43.497673'),
...
('us3hvvt5rtp07wena53cn6zjqasng36l', 'eyJ1c2VyaWQiOjR9:1pI5R7:wKiij9gpmBjpj_Fsjc3UZTRGwEtf7PIceqhR1y9eUDA', '2023-02-01 10:12:53.037476'),
...
(1, 'Gopinath', 'tmksmanju14@gmail.com', 'Gopinath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
(2, 'Manjunath', 'tmksmanju14@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Vijayangar', 'Male'),
(3, 'Ashok', 'tmksmanju14@gmail.com', 'Ashok', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,5th Cross,Malleshwaram', 'Male');
...
(47, 'Convolutional Neural Network(CNN)', '51.94444444444445'),
(48, 'SVM', '50.27777777777778'),
(49, 'Gradient Boosting Classifier', '46.666666666666664'),
(50, 'Extra Tree Classifier', '51.11111111111111'),
(51, 'Decision Tree Classifier', '47.5'),
(52, 'SVM', '47.77777777777778'),
(53, 'Logistic Regression', '46.666666666666664'),
(54, 'Gradient Boosting Classifier', '52.22222222222223');
...
(16, 'No Heart Rate Variability Found', '66.66666666666666'),
(17, 'Heart Rate Variability Found', '33.33333333333333');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_heart_rate_variability`
--

CREATE TABLE IF NOT EXISTS `remote_user_heart_rate_variability` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `remote_user_heart_rate_variability`
--

INSERT INTO `remote_user_heart_rate_variability` (`id`, `Fid`, `gender`, `age`, `R1`, `R2`, `BMI`, `hypertension`, `heart_disease`, `ever_married`, `work_type`, `Residence_type`, `avg_glucose_level`, `smoking_status`, `Prediction`) VALUES
(1, '172.217.12.194-10.42.0.211-443-37390-6', 'Female', '69', '86.7052', '92.0227', '20.4', '0', '0', 'No', 'Private', 'Urban', '94.39', 'never smoked', 'Heart Rate Variability Found'),
(2, '10.42.0.42-106.39.162.36-33690-80-6', 'Female', '81', '89.8204', '91.9571', '26.46', '1', '0', 'Yes', 'Private', 'Rural', '80.43', 'never smoked', 'No Heart Rate Variability Found'),
(3, '10.42.0.151-10.42.0.1-18122-53-17', 'Female', '54', '90.4375', '90.1645', '29.51', '0', '0', 'Yes', 'Private', 'Urban', '104.51', 'smokes', 'No Heart Rate Variability Found'),
(4, '180.149.153.234-10.42.0.42-80-32781-6', 'Male', '57', '98.904', '92.0669', '22.9', '0', '1', 'No', 'Govt_job', 'Urban', '217.08', 'Unknown', 'No Heart Rate Variability Found'),
(5, '10.42.0.211-34.200.28.185-37048-80-6', 'Male', '59', '95.0147', '100.96', '27.46', '0', '0', 'Yes', 'Self-employed', 'Rural', '118.03', 'smokes', 'Heart Rate Variability Found'),
(6, '10.42.0.42-54.173.220.111-43921-443-6', 'Female', '78', '82.645', '97.6169', '26.87', '0', '0', 'Yes', 'Private', 'Urban', '67.29', 'never smoked', 'No Heart Rate Variability Found');
